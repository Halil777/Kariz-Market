...
__decorate([
    ...
    __metadata("design:type", String)
], WishlistItem.prototype, "deviceId", void 0);
__decorate([
...
exports.WishlistItem = WishlistItem = __decorate([
    ...
    (0, typeorm_1.Index)(['userId', 'productId'], { unique: true, where: 'user_id IS NOT NULL' }),
    (0, typeorm_1.Index)(['deviceId', 'productId'], { unique: true, where: 'device_id IS NOT NULL' })
], WishlistItem);
